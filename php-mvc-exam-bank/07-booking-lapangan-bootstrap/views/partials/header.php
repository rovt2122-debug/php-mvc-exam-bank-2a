...
<nav class="navbar navbar-expand navbar-dark bg-primary mb-4">
  <div class="container">
    ...
    <ul class="navbar-nav me-auto">
      <li class="nav-item"><a class="nav-link" href="index.php?page=lapangan">Lapangan</a></li><li class="nav-item"><a class="nav-link" href="index.php?page=jadwal">Jadwal</a></li><li class="nav-item"><a class="nav-link" href="index.php?page=booking">Booking</a></li>
    </ul>
