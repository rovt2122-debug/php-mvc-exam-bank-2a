...
require __DIR__ . '/../models/Kendaraan.php';
require __DIR__ . '/../models/Pelanggan.php';
require __DIR__ . '/../models/Transaksi.php';
require __DIR__ . '/../controllers/AuthController.php';
require __DIR__ . '/../controllers/KendaraanController.php';
...
switch ($page) {
    ...
    case 'kendaraan': (new KendaraanController($pdo))->index(); break;
    case 'kendaraan-form': (new KendaraanController($pdo))->form(); break;
    case 'kendaraan-simpan': (new KendaraanController($pdo))->simpan(); break;
    case 'kendaraan-hapus': (new KendaraanController($pdo))->hapus(); break;
    ...
    case 'transaksi-lunas': (new TransaksiController($pdo))->lunas(); break;
