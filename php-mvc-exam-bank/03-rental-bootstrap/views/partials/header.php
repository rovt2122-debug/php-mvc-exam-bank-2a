...
<nav class="navbar navbar-expand navbar-dark bg-primary mb-4">
  <div class="container">
    ...
    <ul class="navbar-nav me-auto">
      <li class="nav-item"><a class="nav-link" href="index.php?page=kendaraan">Kendaraan</a></li><li class="nav-item"><a class="nav-link" href="index.php?page=pelanggan">Pelanggan</a></li><li class="nav-item"><a class="nav-link" href="index.php?page=transaksi">Transaksi Rental</a></li>
    </ul>
